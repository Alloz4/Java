...
public class Eje12 {
	...
	public static void main(String[] args) {
		...
		/*
		 * t1 y t2, son iguales, incluidas y equivalente t3 y t1, no son iguales, t3
		 * esta incluida en t1, no son equivalentes t4 y t1, no son iguales, si estan
		 * incluidas y si son equivalentes
		 */
	...
	// el mismo tamaño y todos los elementos de Ta tienen el mismo valor y posición
	// en la tabla Tb.
