...
/**
 * Write a description of class ListaNodos2 here.
 * 
 * Lista de nodos que incluye un puntero al primer y ultimo elemento
 * 
 * @author (your name) 
...
public class ListaNodos2 
{
   ...
   /*
    * Inserta un elemento de la lista en orden
    * Se supone que la lista está ordenada
    */ 
    
   public void ponEnOrden ( int valor) {
       if ( estaVacia () ) ponAlPrincipio(valor);
       else 
       if ( valor < primero.valor ) ponAlPrincipio(valor);
       else 
       if ( valor > ultimo.valor ) ponAlFinal(valor);
       else
       {
        // Pongo por el medio
        Nodo p2 = primero;
